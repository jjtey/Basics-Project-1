...
const reversedChoices = [
  ...
  "reversed paper",
  "reversed scissors",
]; //array is reversed but sorted where choices[i] wins choices[i+1] and choices[n] wraps around to win choices[0]
...
var main = function (input) {
  if (!userName) {
    ...
    userName = input;
    var gameInstructions = `Hi ${userName}, welcome to Scissors Paper Stone! ✌️✋👊<br><br> To play, input "Scissors", "Paper" or "Stone" to test your luck!<br><br>Alternatively, input "Reversed Scissors", "Reversed Paper" or "Reverse Stone" to try your hand at Reversed Scissors Paper Stone!<br><br>Good luck!`;
    return gameInstructions;
  }
